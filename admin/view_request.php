<?php 
		include ('../classes/all_function_7.php');
                 ...
                 if(isset($_GET['deact'])){
                     ...
                     $deact=$fun->edit_data("request",$status,$update);
                     if($deact){
   ...
   $del=$fun->delete_data("request",$data);
   if($del){
       header("location:view_request.php");
   }
}
									...
									<div class="card-body">
										...
										<table id="example" class="table table-striped table-bordered border-t0  w-100">
											<thead>
												...
												<?php
								                    $no=1;
								                    $result=$fun->fetch_data_or("request","id","DESC");
												...
												<tr id="<?php echo $value["id"]; ?>">
                                                    ...
                                                    <td><?php
                                                        ...
                                                        if($state==1) {
                                                            ?>
                                                            <a class="btn-outline-dark   p-2" href="?deact=<?php echo $value['id']; ?>">Check</a>

                                                            <?php
                                                        }else { ?>
                                                            <a class=" btn-outline-danger p-2" href="?act=<?php echo $value['id']; ?>">Uncheck</a>
													...
													<td class="w-20"><?php echo $value['phone']; ?></td>
													<td class="w-20"><?php echo $value['message']; ?></td>
